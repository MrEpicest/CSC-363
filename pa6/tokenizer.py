...
class Tokenizer:
    ...
    negative_antecedents = [TokenType.ASSIGN,
                            TokenType.PLUS,
                            TokenType.MINUS,
                            TokenType.TIMES,
                            TokenType.DIVIDE,
    ...
    def nexttoken(self, previous: Token | None) -> Token:
        ...
        match char:
            ...
            case '-':                
                if previous is None or previous.tokentype in self.negative_antecedents:
                    return Token(TokenType.NEGATIVE, lexeme = f"{char}")
                else:
